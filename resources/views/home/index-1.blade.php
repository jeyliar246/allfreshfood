<x-home-layout>
        ...
        <section class="hero-section position-relative">
            <div class="hero-backgrounds">
                <div class="hero-bg active" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{asset('assets/slider.png')}}')"></div>
                <div class="hero-bg" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{asset('assets/slider2.png')}}')"></div>
                <div class="hero-bg" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{asset('assets/slider.png')}}')"></div>
            </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form method="GET" action="{{ route('home.browse') }}" class="search-wrapper mx-auto">
                            <div class="postcode-search bg-white rounded-3 p-2 d-flex align-items-center gap-2">
                                ...
                                <input type="text" name="postcode" class="form-control border-0 flex-grow-1" placeholder="Enter your location" id="postcodeInput">
                                ...
                                <div class="card vendor-card h-100 border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-muted small mb-2">
                                            <i class="bi bi-geo-alt-fill text-primary"></i> {{ $vendor->location ?? 'N/A' }}
                                        </p>
            ...
            <div class="container">
                <div class="row g-4">
                    <div class="col-md-3 text-center">
                        <div class="feature-icon rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 80px; height: 80px;">
