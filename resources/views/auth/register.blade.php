                            ...
                            <form  method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="phone" minlength="11" maxlength="11" placeholder="07123456789" required>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="postcode" class="form-control" id="postcode" minlength="6" maxlength="8" placeholder="G811AA" required>
                                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addressInput.addEventListener('blur', function() {
                if (this.value.trim().length > 0 && this.value.trim().length < 5) {
                    this.classList.add('is-invalid');
                    this.classList.remove('is-valid');
                    showError(this, 'Please enter a complete address');
