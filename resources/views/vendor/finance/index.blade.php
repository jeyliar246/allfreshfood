            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-0 small">Total Orders Delivered: £{{ number_format($deliveredTotal, 2) }} </p>
                        <p class="mb-0 small">Total Paid Out: £{{ number_format($payoutTotal, 2) }}</p>
                        <p class="mb-0 small">Pending Orders Total: £{{ number_format($pendingTotal, 2) }} <small class="text-danger">Not included in available balance</small></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('vendor.withdrawals.store') }}" method="POST" class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="notes" class="form-control" rows="1" placeholder="Optional">{{ old('notes') }}</textarea>
                            </div>
                            <div class="col-12">
