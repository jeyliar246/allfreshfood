                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" id="halal" value="1" name="halal"
                                                {{ old('halal') ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" id="vegan" value="1" name="vegan"
                                                {{ old('vegan') ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" id="gluten_free" value="1"
                                                name="gluten_free" {{ old('gluten_free') ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="organic" class="form-label">Organic</label>
                                            <input type="checkbox" id="organic" value="1" name="organic"
                                                {{ old('organic') ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" id="fair_trade" value="1" name="fair_trade"
                                                {{ old('fair_trade') ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="non_GMO" class="form-label">Non GMO</label>
                                            <input type="checkbox" id="non_GMO" value="1" name="non_GMO"
                                                {{ old('non_GMO') ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('deal') is-invalid @enderror"
                                                id="deal" name="deal" required>
                                                <option value="active"
                                                    {{ old('deal') == 'active' ? 'selected' : '' }}>Active</option>
                                                <option value="inactive"
                                                    {{ old('deal') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                            @error('deal')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
