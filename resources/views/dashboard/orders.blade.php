                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Total:</strong> £{{ number_format($order->total, 2) }}
                                        </p>
                                        <p class="mb-1"><strong>Delivery Fee:</strong>
                                            £{{ number_format($order->delivery_fee, 2) }}</p>
                                        <p class="mb-1"><strong>Date:</strong>
                                            {{ $order->created_at->format('M d, Y H:i') }}</p>
                                        <p class="mb-1"><strong>Delivery
                                                Address:</strong><br />{{ $order->user->address ?? $order->guest_address }}
                                        </p>
                                        <p class="mb-1">
