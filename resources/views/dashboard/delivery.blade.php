                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($deliveries as $key => $delivery)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>{{ $delivery->order->user->name ?? $delivery->order->guest_name  }}</td>
                                                    <td>{{ optional($delivery->deliveryPerson)->name ?? 'Unassigned' }}</td>
                                                    <td>{{ ucfirst($delivery->status) }}</td>
                                                    <td>{{ optional($delivery->pickup_time)->format('Y-m-d H:i') ?? 'N/A' }}</td>
                                                    <td>{{ optional($delivery->delivery_time)->format('Y-m-d H:i') ?? 'N/A' }}</td>
