                    ...
                    <div class="card-body">
                        @if($vendor->orders->count() > 0)
                            ...
                            @if($vendor->orders->count() > 5)
                                <div class="text-center mt-3">
                                    <a href="{{ route('orders.index', ['vendor_id' => $vendor->id]) }}" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group list-group-flush mb-3">
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <span class="fw-medium">£{{ number_format($vendor->orders->sum('total_amount'), 2) }}</span>
                            </div>
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <div>
                        ...
                        <div class="d-grid">
                            @if($vendor->is_approved)
                                <form action="{{ route('vendors.suspend', $vendor) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="btn btn-outline-warning w-100 mb-2">
                                        <i class="bi bi-pause-circle me-2"></i> Suspend Vendor
                                    </button>
                                </form>
                            @else
                                <form action="{{ route('vendors.approve', $vendor) }}" method="POST" class="d-inline">
                            ...
                            <button type="button" class="btn btn-outline-danger w-100" data-bs-toggle="modal" data-bs-target="#deleteVendorModal">
                                <i class="bi bi-trash me-2"></i> Delete Vendor
                            </button>
                        </div>
                    </div>
