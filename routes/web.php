...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/markup/create', [MarkUpController::class, 'create'])->name('markups.create');
    Route::post('/markup', [MarkUpController::class, 'store'])->name('markup.store');
    Route::get('/markup/{id}/edit', [MarkUpController::class, 'edit'])->name('markup.edit');
    Route::put('/markup/{id}', [MarkUpController::class, 'update'])->name('markup.update');
    Route::delete('/markup/{id}', [MarkUpController::class, 'destroy'])->name('markup.destroy');
